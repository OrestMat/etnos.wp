        ...
        <tbody>
          ...
          ?>
              <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
                ...
                <td class="product-price" id="product-price" data-title="<?php esc_attr_e('Price', 'woocommerce'); ?>">
                  <?php
                ...
                <td class="product-subtotal" id="product-subtotal" data-title="<?php esc_attr_e('Subtotal', 'woocommerce'); ?>">
                  <?php
