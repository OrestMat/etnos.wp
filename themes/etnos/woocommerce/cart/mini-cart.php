...
<div class="etnos-header-mini-cart">
  ...
  <?php if (!WC()->cart->is_empty()) : ?>
    <div class="cart_gallery">
      ...
      ?>
          ...
          <div class="etnos-header-mini-cart-item  <?php echo esc_attr(apply_filters('woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key)); ?> ">
  ...
  <?php else : ?>
    ...
    <div class="cart_gallery">
      <p class="woocommerce-mini-cart__empty-message"><?php _e('No products in the cart.', 'etnos'); ?></p>
    </div>
  <?php endif; ?>
